...
class _TopheadlinesState extends State<Topheadlines> {
  ...
  getdetails() async {
    ...
    await Provider.of<Detailsprovider>(context, listen: false).topheadline();
    details = Provider.of<Detailsprovider>(context, listen: false).topdetails;
    print(details);
    setState(() {
      _isLoading = false;
    });
                ...
                Container(
                  ...
                  child: TextFormField(
                    ...
                    decoration: InputDecoration(
                        hintText: 'Search eg. Title Content',
